...
def all_region(list_of_indels, chrdict, outfilename, num_of_genomes):
    ...
    outfile2.write("track type=bedGraph name='DPGP indel size'"  + " description='BedGraph format' visibility=full color=60,0,0 altColor=60,0,0 priority=20" + "\r\n")
    outfile3.write("track type=bedGraph name='DPGP indel freq'" + outfilename + " description='BedGraph format' visibility=full color=0,0,60 altColor=0,0,60 priority=20" + "\r\n")
